...
class UrlValidation extends ValidationRuleBase
{
    ...
    protected string $errorMessage = 'Field {fieldName} must be a valid URL. Provided value: {value}';
    ...
    public function validate(mixed $testTestValue, FieldBase $field): bool
    {
        ...
        return filter_var($testTestValue, FILTER_VALIDATE_URL) !== false;
    }
    ...
    {
        return "function(value) { if (!value) return true; try { new URL(value); return true; } catch { return false; } }";
    }
}